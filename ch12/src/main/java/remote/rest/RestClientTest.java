...
public class RestClientTest {
	...
	private static final String URL_GET_ALL_SINGERS = "http://localhost:8080/singer/listdata"; //урл для доступа к различным операциям
	...
	public void testFindAll() {
		...
		Singers singers = restTemplate.getForObject(URL_GET_ALL_SINGERS, Singers.class); //соответствует методу гет доступа по протоколу хттп
	...
	public void testUpdate() {
		...
		restTemplate.put(URL_UPDATE_SINGER, singer, 1); //метод put
	...
	public void testDelete() {
		...
		restTemplate.delete(URL_DELETE_SINGER, 3); //delete
	...
	public void testCreate() {
		...
		singerNew = restTemplate.postForObject(URL_CREATE_SINGER, singerNew, Singer.class); //Post
